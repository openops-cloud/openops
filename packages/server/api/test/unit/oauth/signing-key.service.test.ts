...
// Stand-in for AES: an invertible transform, so "the stored column holds no
// plaintext PEM" and "the service decrypts before signing" are both testable
// without depending on the real encryption key being loaded.

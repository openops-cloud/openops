...
// `consumedAt: IsNull()` arrives as a TypeORM `FindOperator`. Honouring it is what makes
// the single-use assertions real: ignoring it would report every update as affecting a row.
...
} from '../../../../src/app/oauth/authorization/pending-authorization.service';

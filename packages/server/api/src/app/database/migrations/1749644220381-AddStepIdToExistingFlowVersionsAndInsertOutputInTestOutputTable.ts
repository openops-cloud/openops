...
export class AddStepIdToExistingFlowVersionsAndInsertOutputInTestOutputTable1749644220381
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    logger.info(
      'AddStepIdToExistingFlowVersionsAndInsertOutputInTestOutputTable1749644220381: starting',
    );
    ...
    logger.info(
      'AddStepIdToExistingFlowVersionsAndInsertOutputInTestOutputTable1749644220381: completed',
    );
  }

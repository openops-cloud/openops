...
import { AddTestRunActionLimitsToFlowVersion1760429290005 } from './migrations/1760429290001-AddTestRunActionLimitsToFlowVersion';
...
const getMigrations = (): (new () => MigrationInterface)[] => {
  return [
    ...
    AddTestRunActionLimitsToFlowVersion1760429290005,
  ];
};

...
const systemPropDefaultValues: Partial<Record<SystemProp, string>> = {
  ...
  [AppSystemProp.OAUTH_ENABLED]: 'false',
  [AppSystemProp.OAUTH_ACCESS_TOKEN_TTL_SECONDS]: '900',
  [AppSystemProp.OAUTH_REFRESH_TOKEN_TTL_DAYS]: '30',
  [AppSystemProp.OAUTH_EXCHANGE_TOKEN_TTL_SECONDS]: '300',

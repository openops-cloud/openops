...
export enum AppSystemProp {
  ...
  DB_TYPE = 'DB_TYPE',
  DB_SYNCHRONIZE_SCHEMA = 'DB_SYNCHRONIZE_SCHEMA',
  ...
  OAUTH_REFRESH_TOKEN_TTL_DAYS = 'OAUTH_REFRESH_TOKEN_TTL_DAYS',
  OAUTH_EXCHANGE_TOKEN_TTL_SECONDS = 'OAUTH_EXCHANGE_TOKEN_TTL_SECONDS',
  OAUTH_SIGNING_KEY_PEM_PATH = 'OAUTH_SIGNING_KEY_PEM_PATH',
  OAUTH_RS_CLIENT_SECRET = 'OAUTH_RS_CLIENT_SECRET',
...
export enum SharedSystemProp {
  ...
  DUAL_LOGGING_ENABLED = 'DUAL_LOGGING_ENABLED',
  ...
  ENGINE_QUEUE_UPDATES_ENABLED = 'ENGINE_QUEUE_UPDATES_ENABLED',
  ENGINE_METADATA_CACHE_ENABLED = 'ENGINE_METADATA_CACHE_ENABLED',
  FAST_SHUTDOWN_ENABLED = 'FAST_SHUTDOWN_ENABLED',
  REQUIRE_ENGINE_VALIDATE_AUTH = 'REQUIRE_ENGINE_VALIDATE_AUTH',

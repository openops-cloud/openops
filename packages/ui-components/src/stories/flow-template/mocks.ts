...
const categoryLogos = {
  AWS: '/blocks/aws.png',
  Azure: '/blocks/azure.svg',
  GCP: '/blocks/google-cloud.svg',
};
...
const blocks: BlockMetadataModelSummary[] = [
  ...
  },
  {
    ...
    auth: {
      ...
      authProviderLogoUrl: '/blocks/flexera-spot.png',
      description:

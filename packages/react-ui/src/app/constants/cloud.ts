...
export const OPENOPS_CONNECT_MAX_POLL_ATTEMPTS = 500;
export const OPENOPS_CLOUD_USER_INFO_API_URL = `${OPENOPS_CLOUD_URL}/api/v1/user-info`;
export const ORGIN_PROJECT_ID_KEY = 'originProjectId';
export const ORGIN_USER_ID_KEY = 'originUserId';

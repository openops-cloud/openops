...
{{- .Values.app.env.redisHost | default .Values.redis.name -}}
{{- end }}

{{- define "openops.redisPort" -}}
{{- .Values.app.env.redisPort | default (.Values.redis.service.port | toString) -}}
{{- end }}
...
{{- .Values.analytics.env.databaseHost | default .Values.postgres.name -}}
{{- end }}

{{- define "openops.postgresPort" -}}
{{- .Values.analytics.env.databasePort | default (.Values.postgres.service.port | toString) -}}
{{- end }}
